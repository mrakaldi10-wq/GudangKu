<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand">
            <a href=".">
                <img src="{{ asset('img/logo.png') }}" alt="PT. Winaka Medika Indotama"
                    class="navbar-brand-image" style="height: 60px; width: auto; max-height: none;">
            </a>
        </h1>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item @if (request()->routeIs('volumes.*')) active @endif">
                    <a class="nav-link" href="{{ route('volumes.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <i class="ti ti-ruler-measure icon"></i>
                        </span>
                        <span class="nav-link-title">
                            Volume
                        </span>
                ...
                @if (auth()->user()->isAdmin() || auth()->user()->isPetugasGudang())
                ...
                <li class="nav-item @if (request()->routeIs('barang-pending.index') ||
                        request()->routeIs('barang-pending.create') ||
                        request()->routeIs('barang-pending.edit') ||
                        request()->routeIs('barang-pending.show')) active @endif">
                    <a class="nav-link" href="{{ route('barang-pending.index') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <li class="nav-item @if (request()->routeIs('barang-pending.laporan')) active @endif">
                    <a class="nav-link" href="{{ route('barang-pending.laporan') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <i class="ti ti-clock-pause icon"></i>
                        </span>
                        <span class="nav-link-title">
