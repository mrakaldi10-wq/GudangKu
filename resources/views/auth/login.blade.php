    ...
    <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
                ...
                <div class="container-tight">
                    <div class="text-center mb-4">
                        <a href="." class="navbar-brand navbar-brand-autodark"><img src="#" height="36"
                                alt="">PT. WINAKA MEDIKA INDOTAMA</a>
                    </div>
                            ...
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}"
                                        ...
                                        oninvalid="this.setCustomValidity('Alamat email tidak boleh kosong!')"
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="password" name="password"
                                        ...
                                        oninvalid="this.setCustomValidity('Kata sandinya diisi dulu ya!')"
                                        oninput="this.setCustomValidity('')">
                                    @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
            ...
            <div class="col-lg d-none d-lg-block">
                <img src="./dist/static/illustrations/laptop_login.png" height="500"
