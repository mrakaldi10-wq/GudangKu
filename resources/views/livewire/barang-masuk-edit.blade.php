            ...
            <div class="card-body">
                ...
                <div class="row align-items-center mt-2">
                    <div class="col-4">
                        ...
                        <input type="date" wire:model.defer="inputs.{{ $key }}.tanggal_expired"
                            id="inputs.{{ $key }}.tanggal_expired"
                            class="form-control @error('inputs.' . $key . '.tanggal_expired') is-invalid @enderror"
                            placeholder="">
                        @error('inputs.' . $key . '.tanggal_expired')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
