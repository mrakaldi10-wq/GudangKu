                                ...
                                <tbody>
                                    @forelse ($barangs as $row)
                                        <tr>
                                            ...
                                            <td class="align-text-top text-start text-lg-center" data-label="Tgl Expired">
                                                {{ $row->tanggal_expired ? \Carbon\Carbon::parse($row->tanggal_expired)->format('d M Y') : '-' }}
                                            </td>
                                            <td class="align-text-top text-start text-lg-center" data-label="Masuk">
