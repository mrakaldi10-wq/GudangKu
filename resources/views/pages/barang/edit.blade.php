                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="volume_id"
                                                class="form-select @error('volume_id') is-invalid @enderror" id="volume_id">
                                                <option value="">Pilih Volume (opsional)</option>
                                                @foreach ($volumes as $item)
                                                    <option value="{{ $item->id }}" @selected(old('volume_id', $barang->volume_id) == $item->id)>
                                                        {{ $item->nama_volume }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="tanggal_expired" value="{{ old('tanggal_expired', $barang->tanggal_expired) }}"
...
@push('custom_script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            new TomSelect(document.getElementById('volume_id'))
