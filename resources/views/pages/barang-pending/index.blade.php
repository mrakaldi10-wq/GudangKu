    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('barang-pending.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    <a href="{{ route('barang-pending.create') }}" class="btn btn-primary d-sm-none btn-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M12 5l0 14" />
                            <path d="M5 12l14 0" />
            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-secondary align-text-top" data-label="No">
                                        {{ $loop->iteration + $barangPendings->firstItem() - 1 }}
                                    </td>
                                    ...
                                    <td class="align-text-top">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{ route('barang-pending.show', $row->id) }}">
                                                <i class="ti ti-eye icon text-secondary me-2"></i> Detail
                                            </a>
                                            <a class="dropdown-item" href="{{ route('barang-pending.edit', $row->id) }}">
                                                <i class="ti ti-edit icon text-secondary me-2"></i> Edit
                                            </a>
                                            <a class="dropdown-item text-danger" href="#" onclick="handleDelete(`{{ route('barang-pending.destroy', $row->id) }}`)">
                    ...
                    <div class="card-footer d-flex justify-content-center align-items-center">
                        {{ $barangPendings->onEachSide(1)->withQueryString()->links() }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="" method="POST" id="deleteForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Are you sure?</h3>
                    <div class="text-secondary">Do you really want to remove this data?</div>
                </div>
